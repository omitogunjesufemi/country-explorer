...
export default function FavouritesProvider({ children }) {
    ...
    function removeFavourites(countryData) {
        setFavourites((favourites) => (favourites.filter((country) => country.cca3 !== countryData.cca3)));
    }
    ...
    return (
        <FavouritesContext.Provider value={{ favourites, addFavourites, removeFavourites, checkFavourites }}>
            {children}
