        ...
        <>
            <div className="text-white">
                {checkFavourites(countryData)
                    ? <Liked className="size-13 text-blue-600 hover:text-blue-600 px-3 py-1" onClick={(e) => {
                        e.preventDefault();
                        removeFavourites(countryData);
                    }}>Remove</Liked>
                    : <Like className="size-13 text-gray-400 hover:text-green-600 px-3 py-1" onClick={(e) => {
                        e.preventDefault();
